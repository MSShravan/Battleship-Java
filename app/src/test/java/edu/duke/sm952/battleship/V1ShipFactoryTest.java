...
class V1ShipFactoryTest {
    ...
    public void testMakeDestroyer() {
        ...
        Placement v5_2 = new Placement(new Coordinate(5, 2), 'V');
        Ship<Character> bts = f.makeBattleship(v5_2);
        checkShip(bts, "Battleship", 'b', new Coordinate(5, 2), new Coordinate(6, 2), new Coordinate(7, 2), new Coordinate(8, 2));

        Placement v2_2 = new Placement(new Coordinate(2, 2), 'H');
        Ship<Character> crr = f.makeCarrier(v2_2);
        checkShip(crr, "Carrier", 'c', new Coordinate(2, 2), new Coordinate(2, 3), new Coordinate(2, 4), new Coordinate(2, 5), new Coordinate(2, 6), new Coordinate(2, 7));
